const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VENUSAUR]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA}, {EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE_Y, SPECIES_VENUSAUR_MEGA_Y}},
    ...
    [SPECIES_BLASTOISE]             = {{EVO_MEGA_EVOLUTION, ITEM_BLASTOISINITE, SPECIES_BLASTOISE_MEGA}, {EVO_MEGA_EVOLUTION, ITEM_BLASTOISINITE_Y, SPECIES_BLASTOISE_MEGA_Y}},
    ...
    //Custom
    [SPECIES_SHINX_KANTO]           = {{EVO_LEVEL, 15, SPECIES_LUXIO_KANTO}},
    [SPECIES_LUXIO_KANTO]           = {{EVO_LEVEL, 30, SPECIES_LUXRAY_KANTO}},
    [SPECIES_LITWICK_KANTO]         = {{EVO_LEVEL, 41, SPECIES_LAMPENT_KANTO}},
    [SPECIES_LAMPENT_KANTO]         = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CHANDELURE_KANTO}},
	[SPECIES_KRICKETUNE]            = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_KRICKETON},
									{EVO_LEVEL, 25, SPECIES_KRICKALLOUS}},
	[SPECIES_PORYGON_Z]				= {{EVO_MEGA_EVOLUTION, ITEM_CINNABAR_DRIVE, SPECIES_PORYGON_NORMAL}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_FIRE, SPECIES_PORYGON_FIRE}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_WATER, SPECIES_PORYGON_WATER}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_GRASS, SPECIES_PORYGON_GRASS}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_ELECTRIC, SPECIES_PORYGON_ELECTRIC}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_ICE, SPECIES_PORYGON_ICE}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_GROUND, SPECIES_PORYGON_GROUND}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_FIGHTING, SPECIES_PORYGON_FIGHTING}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_POISON, SPECIES_PORYGON_POISON}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_FLYING, SPECIES_PORYGON_FLYING}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_BUG, SPECIES_PORYGON_BUG}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_ROCK, SPECIES_PORYGON_ROCK}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_PSYCHIC, SPECIES_PORYGON_PSYCHIC}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_DRAGON, SPECIES_PORYGON_DRAGON}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_GHOST, SPECIES_PORYGON_GHOST}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_DARK, SPECIES_PORYGON_DARK}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_STEEL, SPECIES_PORYGON_STEEL}, 
											{EVO_MEGA_EVOLUTION, ITEM_CD_FAIRY, SPECIES_PORYGON_FAIRY}},
	[SPECIES_SWOOBAT]				= {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_ALOOBAT}},
    [SPECIES_TIMBURR_KANTO]         = {{EVO_LEVEL, 25, SPECIES_GURDURR_KANTO}},
    [SPECIES_GURDURR_KANTO]         = {{EVO_LEVEL, 42, SPECIES_CONKELDURR_KANTO}},
    [SPECIES_LEDIAN]     	        = {{EVO_LEVEL, 25, SPECIES_LEDENNA}},
    [SPECIES_SANDILE_KANTO]         = {{EVO_LEVEL, 29, SPECIES_KROKOROK_KANTO}},
    [SPECIES_KROKOROK_KANTO]        = {{EVO_LEVEL, 40, SPECIES_MORADILE}},
    [SPECIES_SANDYGAST_KANTO]		= {{EVO_LEVEL, 42, SPECIES_POLTENDULA}},
    [SPECIES_GIBLE_KANTO]           = {{EVO_LEVEL, 24, SPECIES_GABITE_KANTO}},
    [SPECIES_GABITE_KANTO]          = {{EVO_LEVEL, 48, SPECIES_GARCHOMP_KANTO}},
    [SPECIES_SURSKIT_KANTO]         = {{EVO_LEVEL, 22, SPECIES_MASQUERAIN_KANTO}},
    [SPECIES_MASQUERAIN_KANTO]      = {{EVO_LEVEL, 38, SPECIES_ARIDOSPID}},
    [SPECIES_ARBOK]                 = {{EVO_MEGA_EVOLUTION, ITEM_ARBOKITE, SPECIES_ARBOK_MEGA}},
    [SPECIES_KABUTOPS]              = {{EVO_MEGA_EVOLUTION, ITEM_ARBOKITE, SPECIES_KABUTOPS_MEGA}},
    [SPECIES_OMASTAR]               = {{EVO_MEGA_EVOLUTION, ITEM_ARBOKITE, SPECIES_OMASTAR_MEGA}},
    [SPECIES_PIKACHU_ALOLAN]		= {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    [SPECIES_CUBONE_ALOLAN]			= {{EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_EXEGGCUTE_ALOLAN]		= {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_KOFFING_GALARIAN]		= {{EVO_LEVEL, 35, SPECIES_WEEZING_GALARIAN}},
#endif
};
