const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_SHINX_KANTO] = sShinxKantoLevelUpLearnset,
    [SPECIES_LUXIO_KANTO] = sLuxioKantoLevelUpLearnset,
    [SPECIES_LUXRAY_KANTO] = sLuxrayKantoLevelUpLearnset,
     [SPECIES_LITWICK_KANTO] = sLitwickKantoLevelUpLearnset,
     [SPECIES_LAMPENT_KANTO] = sLampentKantoLevelUpLearnset,
     [SPECIES_CHANDELURE_KANTO] = sChandelureKantoLevelUpLearnset,
     [SPECIES_SANDILE_KANTO] = sSandileKantoLevelUpLearnset,
     [SPECIES_KROKOROK_KANTO] = sKrokorokKantoLevelUpLearnset,
     [SPECIES_MORADILE] = sMoradileLevelUpLearnset,
     [SPECIES_TIMBURR_KANTO] = sTimburrKantoLevelUpLearnset,
     ...
     [SPECIES_BASCULEGION_M] = sBasculegionMLevelUpLearnset,
     ...
     [SPECIES_LEDENNA] = sLedennaLevelUpLearnset,
     [SPECIES_FAUVANTIC] = sFauvanticLevelUpLearnset,
     [SPECIES_FLORESTIC] = sFloresticLevelUpLearnset,
