...
#define METATILE_Fortree_NoBridgeBehavior                  0x36B
...
#define METATILE_Petalburg_Eastwarpgrass    0x303
#define METATILE_Petalburg_Southwarpgrass   0x2FB
