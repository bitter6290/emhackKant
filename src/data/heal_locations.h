static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 3, 34},
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 34, 33},
    [HEAL_LOCATION_PALLET_TOWN - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 7, 7},
    [HEAL_LOCATION_CELADON_CITY - 1] = {MAP_GROUP(CELADON_CITY), MAP_NUM(CELADON_CITY), 42, 8},
    [HEAL_LOCATION_CERULEAN_CITY - 1] = {MAP_GROUP(CERULEAN_CITY), MAP_NUM(CERULEAN_CITY), 26, 58},
    [HEAL_LOCATION_SAFFRON_CITY - 1] = {MAP_GROUP(SAFFRON_CITY), MAP_NUM(SAFFRON_CITY), 13, 42},
    [HEAL_LOCATION_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 2, 4},
    [HEAL_LOCATION_CHARTREUSE_CITY - 1] = {MAP_GROUP(CHARTREUSE_CITY), MAP_NUM(CHARTREUSE_CITY), 21, 46},
    [HEAL_LOCATION_FUCHSIA_CITY - 1] = {MAP_GROUP(FUCHSIA_CITY), MAP_NUM(FUCHSIA_CITY), 18, 38},
    [HEAL_LOCATION_COBALT_CITY_OVERWORLD - 1] = {MAP_GROUP(COBALT_CITY_OVERWORLD), MAP_NUM(COBALT_CITY_OVERWORLD), 16, 18},
};
