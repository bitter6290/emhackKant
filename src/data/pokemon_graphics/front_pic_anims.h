...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_LUXIO_KANTO] = sAnims_LuxioKanto,
    [SPECIES_LUXRAY_KANTO] = sAnims_LuxrayKanto,
	[SPECIES_LITWICK_KANTO] = sAnims_LitwickKanto,
	[SPECIES_LAMPENT_KANTO] = sAnims_LampentKanto,
	[SPECIES_CHANDELURE_KANTO] = sAnims_ChandelureKanto,
	[SPECIES_SANDILE_KANTO] = sAnims_SandileKanto,
	[SPECIES_KROKOROK_KANTO] = sAnims_KrokorokKanto,
	[SPECIES_MORADILE] = sAnims_Moradile,
	[SPECIES_TIMBURR_KANTO] = sAnims_TimburrKanto,
	[SPECIES_GURDURR_KANTO] = sAnims_GurdurrKanto,
	[SPECIES_CONKELDURR_KANTO] = sAnims_ConkeldurrKanto,
	[SPECIES_TORKOAL_KANTO] = sAnims_TorkoalKanto,
	[SPECIES_SANDYGAST_KANTO] = sAnims_SandygastKanto,
	
	[SPECIES_KRICKETON] = sAnims_Kricketon,
	[SPECIES_KRICKALLOUS] = sAnims_Krickallous,
