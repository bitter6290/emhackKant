...
#define NEW_LEGENDS SPECIES_ALOOBAT
...
#define CUSTOM_FORMS						 SPECIES_ENAMORUS_THERIAN
...
// Custom Megas
#define CUSTOM_MEGAS						 SPECIES_TORKOAL_KANTO
...
#define SPECIES_EGG SPECIES_ARBOK_MEGA + 1
