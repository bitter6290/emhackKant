...
// Story Key Items
	...
	{
		.name = _("CD Normal"), 
		.itemId = ITEM_CINNABAR_DRIVE, 
		.price = 0, 
		.holdEffect = HOLD_EFFECT_MEGA_STONE, 
		.description = sCinnabarDriveDesc, 
		.pocket = POCKET_ITEMS, 
		.type = ITEM_USE_BAG_MENU, 
		.fieldUseFunc = ItemUseOutOfBattle_CannotUse, 
		.flingPower = 80, 
