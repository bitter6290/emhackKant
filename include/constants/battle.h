...
#define STATUS4_RESISTANCE				(1 << 17)
...
#define STATUS_FIELD_ROCKY_TERRAIN					(1 << 13)
#define STATUS_FIELD_DARK_TERRAIN					(1 << 14)

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_ROCKY_TERRAIN | STATUS_FIELD_DARK_TERRAIN)
...
#define MOVE_EFFECT_PURE_WATER			0x4B
