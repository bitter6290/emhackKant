...
//Custom effects
#define START_CUSTOM_MOVES EFFECT_VICTORY_DANCE

#define EFFECT_ROCKY_TERRAIN 			START_CUSTOM_MOVES + 1	
#define EFFECT_DARK_TERRAIN 			START_CUSTOM_MOVES + 2	//395
#define EFFECT_RESISTANCE 				START_CUSTOM_MOVES + 3
#define EFFECT_PURE_WATER 				START_CUSTOM_MOVES + 4
#define EFFECT_SKITTER_SMACK 			START_CUSTOM_MOVES + 5
#define EFFECT_PRESSUREPOINT 			START_CUSTOM_MOVES + 6
#define EFFECT_BARB_BARRAGE 			START_CUSTOM_MOVES + 7	//400
