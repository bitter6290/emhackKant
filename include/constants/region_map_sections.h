...
#define MAPSEC_VIRIDIAN_FIELD               0xD5
#define MAPSEC_CELADON_BAY					0xD6
#define MAPSEC_VIRIDIAN_DEEPWOODS			0xD7
#define MAPSEC_HIDDEN_GROTTO				0xD8
#define MAPSEC_NIGHTMARE_RANGE				0xD9
#define MAPSEC_PEWTER_RANGE					0xDA
#define MAPSEC_CELADON_SEA					0xDB
#define MAPSEC_CINNABAR_SEA					0xDC
#define MAPSEC_PEWTER_CAVE					0xDD
#define MAPSEC_VERMILION_PLAIN				0xDE
#define MAPSEC_SAFFRON_DRYLANDS				0xDF
#define MAPSEC_CHARTREUSE_CITY				0xE0
#define MAPSEC_EASTERN_RANGE				0xE1
#define MAPSEC_CELADON_RANGE				0xE2
#define MAPSEC_FUCHSIA_SWAMP				0xE3
#define MAPSEC_VIRIDIAN_COMPLEX				0xE4
#define MAPSEC_VIRIDIAN_FIELD_E				0xE5
