...
#define MOVES_CUSTOM		MOVES_COUNT_GEN8

// Custom Moves
#define MOVE_ROCKY_TERRAIN 		MOVES_CUSTOM
#define MOVE_DARK_TERRAIN 		MOVES_CUSTOM + 1
#define MOVE_PURE_WATER 		MOVES_CUSTOM + 2
#define MOVE_VOLCANIC_FLOW 		MOVES_CUSTOM + 3
#define MOVE_SCORCHED_EARTH 	MOVES_CUSTOM + 4
#define MOVE_RESISTANCE 		MOVES_CUSTOM + 5
#define MOVE_SOARING_KICK 		MOVES_CUSTOM + 6
#define MOVE_BOLT_KICK 			MOVES_CUSTOM + 7
#define MOVE_FROST_KICK 		MOVES_CUSTOM + 8
#define MOVE_PRESSURE_POINT		MOVES_CUSTOM + 9
#define MOVE_STRANGE_SYMPHONY 	MOVES_CUSTOM + 10
#define MOVE_ECTOBLAST			MOVES_CUSTOM + 11

#define MOVES_COUNT_CUSTOM	MOVE_ECTOBLAST + 1
