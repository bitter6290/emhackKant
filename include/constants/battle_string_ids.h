...
//custom
#define START_CUSTOM_STRINGIDS STRINGID_PKMNSABILITYPREVENTSABILITY

#define STRINGID_ROCKYTERRAINENDS					  START_CUSTOM_STRINGIDS + 1
#define STRINGID_DARKTERRAINENDS					  START_CUSTOM_STRINGIDS + 2
#define STRINGID_TERRAINBECOMESROCKY				  START_CUSTOM_STRINGIDS + 3
...
#define BATTLESTRINGS_COUNT                           STRINGID_ACCELERATEACTIVATES
