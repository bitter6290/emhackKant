...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
	...
	ANIM_CMD_FULL(PIKACHU_ALOLAN, sAnims_PIKACHU),
	ANIM_CMD_FULL(CUBONE_ALOLAN, sAnims_CUBONE),
	ANIM_CMD_FULL(EXEGGCUTE_ALOLAN, sAnims_EXEGGCUTE),
	ANIM_CMD_FULL(KOFFING_GALARIAN, sAnims_KOFFING),
