const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("Team Rocket?"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("Team Rocket"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("Rocket Admin"),
    ...
    [TRAINER_CLASS_KANTO_LEADER] = _("Gym Leader"),
};
