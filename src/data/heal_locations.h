static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 12, 14},
    [HEAL_LOCATION_CHARTREUSE_CITY - 1] = {MAP_GROUP(CHARTREUSE_CITY), MAP_NUM(CHARTREUSE_CITY), 18, 30},
};
