const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CALYREX, gMonFrontPic_Calyrex),
	 SPECIES_SPRITE(KRICKETON, gMonFrontPic_Kricketon),
	 SPECIES_SPRITE(KRICKALLOUS, gMonFrontPic_Krickallous),
	 SPECIES_SPRITE(LEDENNA, gMonFrontPic_Ledenna),
	 SPECIES_SPRITE(FAUVANTIC, gMonFrontPic_Fauvantic),
	 SPECIES_SPRITE(FLORESTIC, gMonFrontPic_Florestic),
    ...
    SPECIES_SPRITE(SHINX_KANTO, gMonFrontPic_ShinxKanto),
    SPECIES_SPRITE(LUXIO_KANTO, gMonFrontPic_LuxioKanto),
    SPECIES_SPRITE(LUXRAY_KANTO, gMonFrontPic_LuxrayKanto),
    SPECIES_SPRITE(LITWICK_KANTO, gMonFrontPic_LitwickKanto),
	 SPECIES_SPRITE(LAMPENT_KANTO, gMonFrontPic_LampentKanto),
	 SPECIES_SPRITE(CHANDELURE_KANTO, gMonFrontPic_ChandelureKanto),
	 SPECIES_SPRITE(SANDILE_KANTO, gMonFrontPic_SandileKanto),
	 SPECIES_SPRITE(KROKOROK_KANTO, gMonFrontPic_KrokorokKanto),
	 SPECIES_SPRITE(MORADILE, gMonFrontPic_Moradile),
	 SPECIES_SPRITE(TIMBURR_KANTO, gMonFrontPic_TimburrKanto),
	 ...
	 SPECIES_SPRITE(SANDYGAST_KANTO, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(POLTENDULA, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(SURSKIT_KANTO, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(MASQUERAIN_KANTO, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(ARIDOSPID, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(GIBLE_KANTO, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(GABITE_KANTO, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(GARCHOMP_KANTO, gMonFrontPic_CircledQuestionMark),
     
	 SPECIES_SPRITE(ARBOK_MEGA, gMonFrontPic_ArbokMega),
	 SPECIES_SPRITE(BLASTOISE_MEGA_Y, gMonFrontPic_CircledQuestionMark),
	 SPECIES_SPRITE(VENUSAUR_MEGA_Y, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_NORMAL, gMonFrontPic_CircledQuestionMark), //gMonIcon_PorygonXNormal
     SPECIES_SPRITE(PORYGON_FIRE, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_WATER, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_GRASS, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_ELECTRIC, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_ICE, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_FIGHTING, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_POISON, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_GROUND, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_BUG, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_FLYING, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_ROCK, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_PSYCHIC, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_GHOST, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_DRAGON, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_DARK, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_STEEL, gMonFrontPic_CircledQuestionMark),
     SPECIES_SPRITE(PORYGON_FAIRY, gMonFrontPic_CircledQuestionMark),
	
     SPECIES_SPRITE(PIKACHU_ALOLAN, gMonFrontPic_Pikachu),
     SPECIES_SPRITE(CUBONE_ALOLAN, gMonFrontPic_Cubone),
     SPECIES_SPRITE(EXEGGCUTE_ALOLAN, gMonFrontPic_Exeggcute),
     SPECIES_SPRITE(KOFFING_GALARIAN, gMonFrontPic_Koffing),
#endif
...
const struct CompressedSpriteSheet gMonFrontPicTableFemale[] =
{
    ...
    SPECIES_SPRITE(SHINX_KANTO, gMonFrontPic_ShinxKantoF),
    SPECIES_SPRITE(COMBEE, gMonFrontPic_Combee),
    SPECIES_SPRITE(HIPPOPOTAS, gMonFrontPic_Hippopotas),
    SPECIES_SPRITE(HIPPOWDON, gMonFrontPic_Hippowdon),
#endif
