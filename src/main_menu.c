...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_NIDORINO);
...
{
    return CreateMonPicSprite_Affine(SPECIES_NIDORINO, SHINY_ODDS, 0, MON_PIC_AFFINE_FRONT, x, y, 10, TAG_NONE);
}
