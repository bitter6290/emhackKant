const struct Trainer gTrainers[] = {
    ...
    [TRAINER_GRUNT_AQUA_HIDEOUT_4] =
    {
        ...
        .partySize = ARRAY_COUNT(sParty_CamperTim),
        .party = {.ItemCustomMoves = sParty_CamperTim},
        .scalingCoeff = 9,
        .evCoeff = 16,
    },
    ...
    [TRAINER_RANDALL] =
    {
        ...
        .party = {.NoItemCustomMoves = sParty_Randall},
    },
    ...
    [TRAINER_BROCK_1] = 
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Brock1),
        .party = {.ItemCustomMoves = sParty_Brock1},
    },
    [TRAINER_BROCK_2] = 
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        ...
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Brock1),
        .party = {.ItemCustomMoves = sParty_Brock2},
    },
    [TRAINER_BROCK_3] = 
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        ...
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Brock1),
        .party = {.ItemCustomMoves = sParty_Brock3},
    },
    [TRAINER_BROCK_4] = 
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET,
        ...
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_Brock1),
        .party = {.ItemCustomMoves = sParty_Brock4},
    },
};