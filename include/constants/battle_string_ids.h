...
//custom
#define START_CUSTOM_STRINGIDS STRINGID_STOCKPILEDEFFECTWOREOFF

#define STRINGID_ROCKYTERRAINENDS					  START_CUSTOM_STRINGIDS + 1
#define STRINGID_DARKTERRAINENDS					  START_CUSTOM_STRINGIDS + 2
#define STRINGID_TERRAINBECOMESROCKY				  START_CUSTOM_STRINGIDS + 3	//645
#define STRINGID_TERRAINBECOMESDARK					  START_CUSTOM_STRINGIDS + 4
#define STRINGID_TERRAINLOCK						  START_CUSTOM_STRINGIDS + 5
#define STRINGID_STASISACTIVATES					  START_CUSTOM_STRINGIDS + 6
#define STRINGID_ACCELERATEACTIVATES				  START_CUSTOM_STRINGIDS + 7

#define BATTLESTRINGS_COUNT                           STRINGID_ACCELERATEACTIVATES + 1 //650
...
#define B_MSG_TERRAINENDS_DARK		4
#define B_MSG_TERRAINENDS_ROCKY		5
#define B_MSG_TERRAINENDS_COUNT		6
