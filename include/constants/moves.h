...
#define MOVE_DARK_TERRAIN 		MOVES_CUSTOM + 1	//780
...
#define MOVE_SOARING_KICK 		MOVES_CUSTOM + 6	//785	Anim needed
...
#define MOVE_ECTOBLAST			MOVES_CUSTOM + 11	//790	Anim needed
