...
//Custom
#define ABILITY_ROCKY_SURGE 	ABILITIES_COUNT_GEN9
#define ABILITY_SHADE_SURGE		ABILITIES_COUNT_GEN9 + 1	//300
#define ABILITY_ASTRAL_LOCK		ABILITIES_COUNT_GEN9 + 2
#define ABILITY_FIRE_CORE		ABILITIES_COUNT_GEN9 + 3
#define ABILITY_ACCELERATE		ABILITIES_COUNT_GEN9 + 4
#define ABILITY_STASIS			ABILITIES_COUNT_GEN9 + 5

#define ABILITIES_COUNT ABILITY_STASIS + 1
