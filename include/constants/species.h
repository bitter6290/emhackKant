...
#define NEW_SPECIES SPECIES_ENAMORUS

#define SPECIES_MORADILE 		NEW_SPECIES + 1
#define SPECIES_KRICKETON 		NEW_SPECIES + 2
#define SPECIES_KRICKALLOUS 	NEW_SPECIES + 3
#define SPECIES_LEDENNA 		NEW_SPECIES + 4
#define SPECIES_ALOOBAT 		NEW_SPECIES + 5		//910
#define SPECIES_POLTENDULA 		NEW_SPECIES + 6
#define SPECIES_ARIDOSPID 		NEW_SPECIES + 7

#define NEW_LEGENDS SPECIES_ARIDOSPID

#define SPECIES_FAUVANTIC 		NEW_LEGENDS + 1
#define SPECIES_FLORESTIC 		NEW_LEGENDS + 2
#define SPECIES_TERRANTIC 		NEW_LEGENDS + 3		//915
#define SPECIES_AUREATIC 		NEW_LEGENDS + 4

#define FORMS_START SPECIES_AUREATIC
...
#define SPECIES_ARCANINE_HISUIAN             FORMS_START + 89	//1004
...
#define SPECIES_GOODRA_HISUIAN               FORMS_START + 101  //1016
...
#define CUSTOM_FORMS						 SPECIES_CALYREX_SHADOW_RIDER

#define SPECIES_SHINX_KANTO					 CUSTOM_FORMS + 1
#define SPECIES_LUXIO_KANTO					 CUSTOM_FORMS + 2
#define SPECIES_LUXRAY_KANTO				 CUSTOM_FORMS + 3
#define SPECIES_LITWICK_KANTO				 CUSTOM_FORMS + 4
#define SPECIES_LAMPENT_KANTO				 CUSTOM_FORMS + 5
#define SPECIES_CHANDELURE_KANTO			 CUSTOM_FORMS + 6
#define SPECIES_SANDILE_KANTO				 CUSTOM_FORMS + 7
#define SPECIES_KROKOROK_KANTO				 CUSTOM_FORMS + 8
#define SPECIES_TIMBURR_KANTO				 CUSTOM_FORMS + 9
#define SPECIES_GURDURR_KANTO				 CUSTOM_FORMS + 10
#define SPECIES_CONKELDURR_KANTO			 CUSTOM_FORMS + 11
#define SPECIES_TORKOAL_KANTO				 CUSTOM_FORMS + 12
#define SPECIES_SANDYGAST_KANTO				 CUSTOM_FORMS + 13
#define SPECIES_SURSKIT_KANTO				 CUSTOM_FORMS + 14
#define SPECIES_MASQUERAIN_KANTO			 CUSTOM_FORMS + 15
#define SPECIES_GIBLE_KANTO					 CUSTOM_FORMS + 16
#define SPECIES_GABITE_KANTO				 CUSTOM_FORMS + 17
#define SPECIES_GARCHOMP_KANTO				 CUSTOM_FORMS + 18


// Custom Megas
#define CUSTOM_MEGAS						 SPECIES_GARCHOMP_KANTO


#define SPECIES_ARBOK_MEGA					 CUSTOM_MEGAS + 1
#define SPECIES_BLASTOISE_MEGA_Y			 CUSTOM_MEGAS + 2
#define SPECIES_VENUSAUR_MEGA_Y				 CUSTOM_MEGAS + 3
#define SPECIES_OMASTAR_MEGA				 CUSTOM_MEGAS + 4
#define SPECIES_KABUTOPS_MEGA				 CUSTOM_MEGAS + 5


//Mega Porygons
#define PORY_FORMS							 SPECIES_KABUTOPS_MEGA


#define SPECIES_PORYGON_NORMAL				PORY_FORMS + 1
#define SPECIES_PORYGON_FIRE				PORY_FORMS + 2
#define SPECIES_PORYGON_WATER				PORY_FORMS + 3
#define SPECIES_PORYGON_GRASS				PORY_FORMS + 4
#define SPECIES_PORYGON_ELECTRIC			PORY_FORMS + 5
#define SPECIES_PORYGON_ICE					PORY_FORMS + 6
#define SPECIES_PORYGON_GROUND				PORY_FORMS + 7
#define SPECIES_PORYGON_FIGHTING			PORY_FORMS + 8
#define SPECIES_PORYGON_FLYING				PORY_FORMS + 9
#define SPECIES_PORYGON_POISON				PORY_FORMS + 10
#define SPECIES_PORYGON_PSYCHIC				PORY_FORMS + 11
#define SPECIES_PORYGON_BUG					PORY_FORMS + 12
#define SPECIES_PORYGON_ROCK				PORY_FORMS + 13
#define SPECIES_PORYGON_GHOST				PORY_FORMS + 14
#define SPECIES_PORYGON_DRAGON				PORY_FORMS + 15
#define SPECIES_PORYGON_DARK				PORY_FORMS + 16
#define SPECIES_PORYGON_STEEL				PORY_FORMS + 17
#define SPECIES_PORYGON_FAIRY				PORY_FORMS + 18

#define START_SPECIAL_EVOS 					SPECIES_PORYGON_FAIRY

#define SPECIES_PIKACHU_ALOLAN 				START_SPECIAL_EVOS + 1
#define SPECIES_CUBONE_ALOLAN 				START_SPECIAL_EVOS + 2
#define SPECIES_EXEGGCUTE_ALOLAN 			START_SPECIAL_EVOS + 3
#define SPECIES_KOFFING_GALARIAN 			START_SPECIAL_EVOS + 4
