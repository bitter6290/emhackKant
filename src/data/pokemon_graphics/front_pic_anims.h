...
static const union AnimCmd sAnim_ShinxKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_LuxioKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_LuxrayKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_LitwickKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_LampentKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_ChandelureKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_SandileKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_KrokorokKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Moradile_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_TimburrKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_GurdurrKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_ConkeldurrKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_TorkoalKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
static const union AnimCmd sAnim_Krickallous_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Ledenna_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Fauvantic_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Florestic_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Terrantic_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Aureatic_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_Aloobat_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_SandygastKanto_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
static const union AnimCmd sAnim_ArbokMega_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
SINGLE_ANIMATION(ShinxKanto);
SINGLE_ANIMATION(LuxioKanto);
SINGLE_ANIMATION(LuxrayKanto);
SINGLE_ANIMATION(LitwickKanto);
SINGLE_ANIMATION(LampentKanto);
SINGLE_ANIMATION(ChandelureKanto);
SINGLE_ANIMATION(SandileKanto);
SINGLE_ANIMATION(KrokorokKanto);
SINGLE_ANIMATION(Moradile);
SINGLE_ANIMATION(TimburrKanto);
SINGLE_ANIMATION(GurdurrKanto);
SINGLE_ANIMATION(ConkeldurrKanto);
SINGLE_ANIMATION(TorkoalKanto);
SINGLE_ANIMATION(Krickallous);
SINGLE_ANIMATION(Kricketon);
SINGLE_ANIMATION(Ledenna);
SINGLE_ANIMATION(Fauvantic);
SINGLE_ANIMATION(Florestic);
SINGLE_ANIMATION(Terrantic);
SINGLE_ANIMATION(Aureatic);
SINGLE_ANIMATION(Aloobat);
SINGLE_ANIMATION(SandygastKanto);
SINGLE_ANIMATION(Poltendula);
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    //custom mons
		...
		[SPECIES_LUXIO_KANTO] = sAnims_ShinxKanto,
		[SPECIES_LUXRAY_KANTO] = sAnims_ShinxKanto,
		[SPECIES_TIMBURR_KANTO] = sAnims_ShinxKanto,
		[SPECIES_GURDURR_KANTO] = sAnims_ShinxKanto,
		[SPECIES_CONKELDURR_KANTO] = sAnims_ShinxKanto,
		[SPECIES_LITWICK_KANTO] = sAnims_ShinxKanto,
		[SPECIES_LAMPENT_KANTO] = sAnims_ShinxKanto,
		[SPECIES_CHANDELURE_KANTO] = sAnims_ShinxKanto,
		[SPECIES_TORKOAL_KANTO] = sAnims_ShinxKanto,
		[SPECIES_SANDYGAST_KANTO] = sAnims_ShinxKanto,
		[SPECIES_POLTENDULA] = sAnims_ShinxKanto,
		[SPECIES_SANDILE_KANTO] = sAnims_ShinxKanto,
		[SPECIES_KROKOROK_KANTO] = sAnims_ShinxKanto,
		[SPECIES_MORADILE] = sAnims_ShinxKanto,
		[SPECIES_SURSKIT_KANTO] = sAnims_ShinxKanto,
		[SPECIES_MASQUERAIN_KANTO] = sAnims_ShinxKanto,
		[SPECIES_ARIDOSPID] = sAnims_ShinxKanto,
		[SPECIES_GIBLE_KANTO] = sAnims_ShinxKanto,
		[SPECIES_GABITE_KANTO] = sAnims_ShinxKanto,
		[SPECIES_GARCHOMP_KANTO] = sAnims_ShinxKanto,
		[SPECIES_KRICKETON] = sAnims_ShinxKanto,
		[SPECIES_KRICKALLOUS] = sAnims_ShinxKanto,
		[SPECIES_LEDENNA] = sAnims_ShinxKanto,
		[SPECIES_ALOOBAT] = sAnims_ShinxKanto,
		
		[SPECIES_FAUVANTIC] = sAnims_ShinxKanto,
		[SPECIES_FLORESTIC] = sAnims_ShinxKanto,
		[SPECIES_TERRANTIC] = sAnims_ShinxKanto,
		[SPECIES_AUREATIC] = sAnims_ShinxKanto,
		
		[SPECIES_ARBOK_MEGA] = sAnims_ShinxKanto,
		[SPECIES_VENUSAUR_MEGA_Y] = sAnims_ShinxKanto,
		[SPECIES_BLASTOISE_MEGA_Y] = sAnims_ShinxKanto,
		[SPECIES_KABUTOPS_MEGA] = sAnims_ShinxKanto,
		[SPECIES_OMASTAR_MEGA] = sAnims_ShinxKanto,
	
	[SPECIES_PIKACHU_ALOLAN] = sAnims_Pikachu,
	[SPECIES_CUBONE_ALOLAN] = sAnims_Cubone,
	[SPECIES_EXEGGCUTE_ALOLAN] = sAnims_Exeggcute,
	[SPECIES_KOFFING_GALARIAN] = sAnims_Koffing,
#endif
