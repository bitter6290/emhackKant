...
// New Mega Stones
#define START_NEW_MEGA_STONES 	ITEM_ROPE + 1

#define ITEM_VENUSAURITE_Y		START_NEW_MEGA_STONES		//760
#define ITEM_BLASTOISINITE_Y	START_NEW_MEGA_STONES + 1	
#define ITEM_ARBOKITE			START_NEW_MEGA_STONES + 2	
#define ITEM_CINNABAR_DRIVE		START_NEW_MEGA_STONES + 3	
#define ITEM_CD_FIRE			START_NEW_MEGA_STONES + 4	
#define ITEM_CD_WATER			START_NEW_MEGA_STONES + 5	//765
#define ITEM_CD_GRASS			START_NEW_MEGA_STONES + 6	
#define ITEM_CD_ELECTRIC		START_NEW_MEGA_STONES + 7	
#define ITEM_CD_ICE				START_NEW_MEGA_STONES + 8	
#define ITEM_CD_GROUND			START_NEW_MEGA_STONES + 9	
#define ITEM_CD_FIGHTING		START_NEW_MEGA_STONES + 10	//770
#define ITEM_CD_POISON			START_NEW_MEGA_STONES + 11	
#define ITEM_CD_FLYING			START_NEW_MEGA_STONES + 12	
#define ITEM_CD_BUG				START_NEW_MEGA_STONES + 13	
#define ITEM_CD_ROCK			START_NEW_MEGA_STONES + 14	
#define ITEM_CD_PSYCHIC			START_NEW_MEGA_STONES + 15	//775
#define ITEM_CD_DRAGON			START_NEW_MEGA_STONES + 16	
#define ITEM_CD_GHOST			START_NEW_MEGA_STONES + 17	
#define ITEM_CD_DARK			START_NEW_MEGA_STONES + 18	
#define ITEM_CD_STEEL			START_NEW_MEGA_STONES + 19	
