...
#include "constants/gym_leader_ids.h"
...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_CALEB_PEWTER_MINE, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
...
{
	return min(4,max(storyChapter,(badges+storyChapter-1)/3));
}
