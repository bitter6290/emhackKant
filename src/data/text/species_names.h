...
//Hisuian Forms
    ...
    [SPECIES_LUXRAY_KANTO] = _("Luxray"),
     [SPECIES_LITWICK_KANTO] = _("Litwick"),
     [SPECIES_LAMPENT_KANTO] = _("Lampent"),
     [SPECIES_CHANDELURE_KANTO] = _("Chandelure"),
     [SPECIES_SANDILE_KANTO] = _("Sandile"),
     [SPECIES_KROKOROK_KANTO] = _("Krokorok"),
     [SPECIES_MORADILE] = _("Moradile"),
     [SPECIES_TIMBURR_KANTO] = _("Timburr"),
     ...
     [SPECIES_FAUVANTIC] = _("Fauvantic"),
     [SPECIES_FLORESTIC] = _("Florestic"),
     [SPECIES_TERRANTIC] = _("Terrantic"),
     [SPECIES_AUREATIC] = _("Aureatic"),
     [SPECIES_ALOOBAT] = _("Aloobat"),
     [SPECIES_SANDYGAST_KANTO] = _("Sandygast"),
     [SPECIES_POLTENDULA] = _("Poltendula"),
     [SPECIES_ARBOK_MEGA] = _("Arbok"),
     [SPECIES_BLASTOISE_MEGA_Y] = _("Blastoise"),
     [SPECIES_VENUSAUR_MEGA_Y] = _("Venusaur"),
     [SPECIES_PORYGON_NORMAL] = _("Porygon-Z"),
     [SPECIES_PORYGON_FIRE] = _("Porygon-Z"),
     [SPECIES_PORYGON_WATER] = _("Porygon-Z"),
     [SPECIES_PORYGON_GRASS] = _("Porygon-Z"),
     [SPECIES_PORYGON_ELECTRIC] = _("Porygon-Z"),
     [SPECIES_PORYGON_ICE] = _("Porygon-Z"),
     [SPECIES_PORYGON_FIGHTING] = _("Porygon-Z"),
     [SPECIES_PORYGON_POISON] = _("Porygon-Z"),
     [SPECIES_PORYGON_GROUND] = _("Porygon-Z"),
     [SPECIES_PORYGON_BUG] = _("Porygon-Z"),
     [SPECIES_PORYGON_FLYING] = _("Porygon-Z"),
     [SPECIES_PORYGON_ROCK] = _("Porygon-Z"),
     [SPECIES_PORYGON_PSYCHIC] = _("Porygon-Z"),
     [SPECIES_PORYGON_GHOST] = _("Porygon-Z"),
     [SPECIES_PORYGON_DRAGON] = _("Porygon-Z"),
