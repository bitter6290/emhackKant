...
static const struct TrainerMonItemCustomMoves sParty_GruntAquaHideout4[] = {
    ...
    .ability = 0,
    .moves = {MOVE_BUG_BITE, MOVE_TACKLE, MOVE_STRING_SHOT}
    },
    {
    .iv = 0,
    .lvl = 10,
    ...
    .ability = 0,
    .moves = {MOVE_POISON_STING, MOVE_HARDEN, MOVE_STRING_SHOT}
    },
    {
    .iv = 0,
    .lvl = 9,
    ...
    .ability = 2,
    .moves = {MOVE_COVET, MOVE_THUNDER_SHOCK, MOVE_PLAY_NICE, MOVE_TAIL_WHIP}
    }
};
