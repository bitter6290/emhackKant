...
//Custom effects
#define START_CUSTOM_MOVES EFFECT_DAMAGE_SET_TERRAIN

#define EFFECT_ROCKY_TERRAIN 			START_CUSTOM_MOVES + 1
#define EFFECT_DARK_TERRAIN 			START_CUSTOM_MOVES + 2
#define EFFECT_RESISTANCE 				START_CUSTOM_MOVES + 3
#define EFFECT_PURE_WATER 				START_CUSTOM_MOVES + 4
#define EFFECT_VICTORY_DANCE 			START_CUSTOM_MOVES + 5	//397
#define EFFECT_PRESSUREPOINT 			START_CUSTOM_MOVES + 6
#define EFFECT_BARB_BARRAGE 			START_CUSTOM_MOVES + 7
#define EFFECT_INFERNAL_PARADE 			START_CUSTOM_MOVES + 8
#define EFFECT_BITTER_MALICE 			START_CUSTOM_MOVES + 9
#define EFFECT_CHLOROBLAST 				START_CUSTOM_MOVES + 10	//402
#define EFFECT_ATTACKER_SPD_DOWN_2_HIT 	START_CUSTOM_MOVES + 11
#define EFFECT_SKITTER_SMACK			START_CUSTOM_MOVES + 12

#define NUM_BATTLE_MOVE_EFFECTS EFFECT_ATTACKER_SPD_DOWN_2_HIT
