...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_VIRIDIAN_FIELD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CELADON_BAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VIRIDIAN_DEEPWOODS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NIGHTMARE_RANGE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PEWTER_RANGE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PEWTER_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_HIDDEN_GROTTO] = MAPPOPUP_THEME_STONE,
};
