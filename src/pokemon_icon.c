...
//custom mons
    ...
    [SPECIES_LUXIO_KANTO] = gMonIcon_LuxioKanto,
    [SPECIES_LUXRAY_KANTO] = gMonIcon_LuxrayKanto,
     [SPECIES_LITWICK_KANTO] = gMonIcon_LitwickKanto,
     [SPECIES_LAMPENT_KANTO] = gMonIcon_LampentKanto,
     [SPECIES_CHANDELURE_KANTO] = gMonIcon_ChandelureKanto,
     [SPECIES_SANDILE_KANTO] = gMonIcon_SandileKanto,
     [SPECIES_KROKOROK_KANTO] = gMonIcon_KrokorokKanto,
     [SPECIES_MORADILE] = gMonIcon_Moradile,
     [SPECIES_TIMBURR_KANTO] = gMonIcon_TimburrKanto,
    ...
    [SPECIES_BASCULEGION_M] = gMonIcon_BasculegionM,
    ...
    [SPECIES_PALKIA_ORIGIN] = gMonIcon_PalkiaOrigin,
     ...
     [SPECIES_LEDENNA] = gMonIcon_Ledenna,
     [SPECIES_FAUVANTIC] = gMonIcon_Fauvantic,
     [SPECIES_FLORESTIC] = gMonIcon_Florestic,
