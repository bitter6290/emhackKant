...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_RopeHole;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ExplosionRock;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Bard;
...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[NUM_OBJ_EVENT_GFX] = {
    ...
    [OBJ_EVENT_GFX_SCI_F] = 				   &gObjectEventGraphicsInfo_ScientistF,
    [OBJ_EVENT_GFX_ROPE_HOLE] = 			   &gObjectEventGraphicsInfo_RopeHole,
};
